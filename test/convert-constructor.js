...
test.skip("stampit.convertConstructor()", (t) => {
  ...
  t.equal(obj.thing, "initialized", "Constructor should execute.");
  ...
  t.equal(obj.base, "base", "Prototype property should be mixed in.");

  t.equal(
    obj.baseFunc && obj.baseFunc(),
    "baseFunc",
...
test.skip("stampit.convertConstructor() composed", (t) => {
  ...
  const BaseOfBase = function () {
    this.baseOfBase = "baseOfBase";
  };
  BaseOfBase.prototype.baseOfBaseFunc = () => {
  ...
  t.equal(thing.thing, "initialized", "Constructor should execute.");
  ...
  t.equal(thing.base, "base", "Prototype property should be mixed in.");

  t.equal(
    thing.baseFunc && thing.baseFunc(),
    "baseFunc",
    "Prototype function should be mixed in.",
  );
  ...
  t.equal(
    thing.baseOfBaseFunc && thing.baseOfBaseFunc(),
    "baseOfBaseFunc",
  ...
  t.equal(u.thing, "initialized", "Constructor should execute.");

  t.equal(u.foo && u.foo(), "foo", "Constructor prototype should be mixed in.");

  t.equal(u.base, "base", "Prototype property should be mixed in.");

  t.equal(
    u.baseFunc && u.baseFunc(),
    "baseFunc",
    "Prototype function should be mixed in.",
  );
  ...
  t.equal(
    u.baseOfBaseFunc && u.baseOfBaseFunc(),
    "baseOfBaseFunc",
    "Prototype function chain should be mixed in.",
  );
  ...
  t.equal(u.baz, "baz", "Should be able to add new methods with .compose()");
